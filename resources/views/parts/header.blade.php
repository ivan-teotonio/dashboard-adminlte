<nav class="app-header navbar navbar-expand bg-body">
        ...
        <div class="container-fluid">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="{{ route('users.index') }}" class="nav-link">Usuários</a></li>
          </ul>
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
              ...
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <!--end::Menu Body-->
                <!--begin::Menu Footer-->
                <li class="user-footer" style="display: flex; justify-content: space-between; align-items: center;">
